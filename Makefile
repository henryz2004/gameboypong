...
OFILES = gba.o font.o main.o images/garbage.o images/poopyocean.o images/default_cube.o images/default_happy.o images/default_hit.o images/default_p.o images/default_wink.o images/bol.o images/background_start.o images/end_screen.o trigtable.o
